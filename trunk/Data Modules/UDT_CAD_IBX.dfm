object DTM_CAD_IBX: TDTM_CAD_IBX
  ...
  object qryLkpcaddvs: TIBQuery
    ...
    object ibstrngfldLkpcaddvsFORN_FANTASIA: TIBStringField
      FieldName = 'FORN_FANTASIA'
      Origin = '"CAD_FORN"."FORN_FANTASIA"'
      Size = 100
    end
  ...
  object qryLkCadSind: TIBQuery
    ...
    SQL.Strings = (
      'select * '
      'from CAD_FORN'
      'where (1=1) and FORN_TPSINDICO = 1')
    Left = 24
    Top = 208
    ...
    object ibstrngfld7: TIBStringField
      FieldName = 'FORN_UF'
      Origin = 'CAD_FORN.FORN_UF'
      Size = 2
    end
    object ibstrngfld8: TIBStringField
      FieldName = 'FORN_TELEFONE'
      Origin = 'CAD_FORN.FORN_TELEFONE'
      Size = 18
    end
    object ibstrngfld9: TIBStringField
      FieldName = 'FORN_RAMAL'
      Origin = 'CAD_FORN.FORN_RAMAL'
      Size = 6
    end
    object ibstrngfld10: TIBStringField
      FieldName = 'FORN_TELEFONE1'
      Origin = 'CAD_FORN.FORN_TELEFONE1'
      Size = 18
    end
    object ibstrngfld11: TIBStringField
      FieldName = 'FORN_EMAIL'
      Origin = 'CAD_FORN.FORN_EMAIL'
      Size = 60
    end
    object ibstrngfld12: TIBStringField
      FieldName = 'FORN_EMAIL1'
      Origin = 'CAD_FORN.FORN_EMAIL1'
      Size = 60
    end
    object ibstrngfld13: TIBStringField
      FieldName = 'FORN_SITE'
      Origin = 'CAD_FORN.FORN_SITE'
      Size = 80
    end
    object ibstrngfld14: TIBStringField
      FieldName = 'FORN_CELULAR'
      Origin = 'CAD_FORN.FORN_CELULAR'
      Size = 18
    end
    object ibstrngfld15: TIBStringField
      FieldName = 'FORN_CELULAR1'
      Origin = 'CAD_FORN.FORN_CELULAR1'
      EditMask = '(99)00000\-9999;1;_'
      Size = 18
    end
    object ibstrngfld16: TIBStringField
      FieldName = 'FORN_RG'
      Origin = 'CAD_FORN.FORN_RG'
      Size = 15
    end
    ...
    object ibstrngfld17: TIBStringField
      FieldName = 'FORN_CONJUGE'
      Origin = 'CAD_FORN.FORN_CONJUGE'
      Size = 14
    end
    ...
    object ibstrngfldLkCadSindFORN_FANTASIA: TIBStringField
      FieldName = 'FORN_FANTASIA'
      Origin = '"CAD_FORN"."FORN_FANTASIA"'
      Size = 100
    end
